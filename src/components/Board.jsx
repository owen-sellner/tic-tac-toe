...
function Board({ gameGrid, setGameGrid, isCircleTurn, winner, winLocation }) {
    ...
    return (
        <>
            ...
            <div className="relative p-[5vw]">
                <div className="relative grid grid-cols-3 grid-rows-3 gap-[1vw]">
                    {gameGrid.map((_, index) => (
                        <div key={index} className="flex items-center p-[1vw] justify-center max-h-[125px] h-[15vw] max-w-[125px] w-[15vw] bg-keppel">
